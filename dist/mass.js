...
(function(global , DOC){
	...
	var list = " ajax,attr,class,css,css_ie,data,dispatcher,ecma,event,fx,lang,node,query,support".match(dom.rword);
            ...
            if (  handlers ) {
                ...
                for ( var i = 0, obj; obj = handlers[i++]; ) {
                    ...
                    if ( !src.disabled && !(event.button && event.type === "click")
                        ...
                        result = obj.handler.apply( this, args );
                        obj.times--;
                        if(obj.times === 0){
